...
if LOAD_MODELS and os.path.exists(stack_path) and os.path.exists(scaler_path) and os.path.exists(scalerC_path) and os.path.exists(clf_path):
    ...
    try:
        ...
        print('Warning: failed to save models to disk; continuing without persistence')
